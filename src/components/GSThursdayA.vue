<template>
  ...
  setup() {
    ...
    const games = ref([
       ...
       { date: '11-09', time: '8:20 PM', courtNumber: "", homeTeam: 'White Owls', awayTeam: 'AIM BLOCC', score: "" },
       { date: '11-09', time: '9:10 PM', courtNumber: "", homeTeam: 'White Owls', awayTeam: 'Sigue Adelante', score: "" },
