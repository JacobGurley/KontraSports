...
<script scoped>
  ...
  setup() {
    ...
    const standingsRef = dbRef(db, 'standingsSunB');
    const winRef = dbRef(db, 'winsTh');
    const lossRef = dbRef(db, 'lossTh');
    const pdRef = dbRef(db, 'pdThur');
    
    const standings = ref([
        {name: "Ball Dont Lie", wins: 1, losses: 1, pointDiff: 1},
        {name: "Hooligans", wins: 1, losses: 1, pointDiff: 1},
        {name: "Mixed Bag", wins: 1, losses: 1, pointDiff: 1},
        {name: "LA Dreamers", wins: 1, losses: 1, pointDiff: 1},
        {name: "Team 1UP", wins: 1, losses: 1, pointDiff: 1},
