    ...
    onMounted(async () => {
      ...
      if (!snapshot.exists()) {
        ...
        const initialRoster = [
            ...
            {team: 'Trailblazians', name: 'Desmond Ethridge', points: 0, gamesPlayed: 1},
            {team: 'Rudeboyz', name: 'Wilton Sy', points: 0, gamesPlayed: 1},
            {team: 'Rudeboyz', name: 'Tyrone Waiters', points: 0, gamesPlayed: 1},
            {team: 'Rudeboyz', name: 'Terrell Waiters', points: 0, gamesPlayed: 1},
            {team: 'Rudeboyz', name: 'Anthony Nocon', points: 0, gamesPlayed: 1},
            {team: 'Rudeboyz', name: 'Randy Ferguson', points: 0, gamesPlayed: 1},
