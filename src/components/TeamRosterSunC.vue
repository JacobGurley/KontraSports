    ...
    onMounted(async () => {
      ...
      if (!snapshot.exists()) {
        ...
        const initialRoster = [
            ...
            {team: 'Bad Boy Mafia', name: 'Steve Urquidi', points: 0, gamesPlayed: 1},
            {team: 'Bad Boy Mafia', name: 'Jairo Balesteros', points: 0, gamesPlayed: 1},
            {team: 'Bad Boy Mafia', name: 'Rudy Cornel', points: 0, gamesPlayed: 1},
            {team: 'Bad Boy Mafia', name: 'Steve Urquidi Sr', points: 0, gamesPlayed: 1},
            {team: 'Bad Boy Mafia', name: 'Joshua Lara', points: 0, gamesPlayed: 1},
            {team: 'Bad Boy Mafia', name: 'Estevan Villa', points: 0, gamesPlayed: 1},
            {team: 'Bad Boy Mafia', name: 'Alexis Lopez', points: 0, gamesPlayed: 1},
