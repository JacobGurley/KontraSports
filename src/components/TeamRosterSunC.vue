    ...
    onMounted(async () => {
      ...
      if (!snapshot.exists()) {
        ...
        const initialRoster = [
            ...
            {team: 'Mamba Mentality', name: 'Josh Ebolo', points: 0, gamesPlayed: 1},
            ...
            {team: 'Gold Hillz Ballers', name: 'Alex Vincent Fujii', points: 0, gamesPlayed: 1},
            {team: 'Gold Hillz Ballers', name: 'Auskia Carroll', points: 0, gamesPlayed: 1},
            {team: 'Gold Hillz Ballers', name: 'Rob Castillo', points: 0, gamesPlayed: 1},
            {team: 'Gold Hillz Ballers', name: 'Omar Gomez', points: 0, gamesPlayed: 1},
