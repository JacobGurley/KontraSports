    ...
    onMounted(async () => {
      ...
      if (!snapshot.exists()) {
        ...
        const initialRoster = [
            ...
            {team: 'Kool Aid Jammers', name: 'Luis Ramirez', points: 0, gamesPlayed: 1},
            {team: 'Kool Aid Jammers', name: 'Ben Hirt', points: 0, gamesPlayed: 1},
            ...
            {team: 'LBSU Rec', name: 'Khanh Bui', points: 0, gamesPlayed: 1},
            {team: 'LBSU Rec', name: 'Jay Fuertez', points: 0, gamesPlayed: 1},
            {team: 'LBSU Rec', name: 'Brandon Hokama', points: 0, gamesPlayed: 1},
            ...
            {team: 'Mamba Mentality', name: 'Mike de Leon', points: 0, gamesPlayed: 1},
            {team: 'Mamba Mentality', name: 'Carlos Alonso', points: 0, gamesPlayed: 1},
            {team: 'Mamba Mentality', name: 'Josh Ebola', points: 0, gamesPlayed: 1},
            {team: '60pointgame', name: 'Jesse So', points: 0, gamesPlayed: 1},
            {team: '60pointgame', name: 'Jason So', points: 0, gamesPlayed: 1},
            {team: '60pointgame', name: 'Jackie So', points: 0, gamesPlayed: 1},
            {team: '60pointgame', name: 'Jimmy So', points: 0, gamesPlayed: 1},
            {team: '60pointgame', name: 'Kam Chor', points: 0, gamesPlayed: 1},
            {team: '60pointgame', name: 'Cory Sybunroeung', points: 0, gamesPlayed: 1},
            {team: '60pointgame', name: 'Jarrod Wilridge', points: 0, gamesPlayed: 1},
            {team: '60pointgame', name: 'Timmy Khun', points: 0, gamesPlayed: 1},
            {team: '60pointgame', name: 'Jay Doung', points: 0, gamesPlayed: 1},
            {team: '60pointgame', name: 'Sokem Mall', points: 0, gamesPlayed: 1},
            {team: '60pointgame', name: 'Kevin Vikchai', points: 0, gamesPlayed: 1},
            {team: 'Mexipinos', name: 'David Cornel', points: 0, gamesPlayed: 1},
            {team: 'Mexipinos', name: 'Nino Magsino', points: 0, gamesPlayed: 1},
            {team: 'Mexipinos', name: 'Dylan Valdez', points: 0, gamesPlayed: 1},
            {team: 'Mexipinos', name: 'Steve Urquidi', points: 0, gamesPlayed: 1},
            {team: 'Mexipinos', name: 'Jairo Balesteros', points: 0, gamesPlayed: 1},
            {team: 'Mexipinos', name: 'Rudy Cornel', points: 0, gamesPlayed: 1},
            {team: 'Mexipinos', name: 'Steve Urquidi Sr', points: 0, gamesPlayed: 1},
            {team: 'Mexipinos', name: 'Joshua Lara', points: 0, gamesPlayed: 1},
            {team: 'Mexipinos', name: 'Estevan Villa', points: 0, gamesPlayed: 1},
            {team: 'Mexipinos', name: 'Alexis Lopez', points: 0, gamesPlayed: 1},
