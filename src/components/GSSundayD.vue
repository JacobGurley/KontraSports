<template>
    ...
    setup() {
      ...
      const games = ref([
         ...
         { date: '11-19', time: '7:30 PM', courtNumber: "", homeTeam: 'Living Grace', awayTeam: 'Deafies', score: "" },
         { date: '11-19', time: '8:30 PM', courtNumber: "", homeTeam: 'Pre-Eminent', awayTeam: 'Bad News Ballerz', score: "" }, 
         { date: '11-19', time: '9:10 PM', courtNumber: "", homeTeam: 'Huggies', awayTeam: 'LBSU Rec', score: "" },
