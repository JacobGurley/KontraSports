      ...
      onMounted(async () => {
        ...
        if (!snapshot.exists()) {
          ...
          const initialRoster = [
            ...
            {team: 'LFG', name: 'Anthony Resendez', points: 0, gamesPlayed: 1},
            {team: 'Dale Gas', name: 'Oscar', points: 0, gamesPlayed: 1},
            {team: 'Dale Gas', name: 'Joe', points: 0, gamesPlayed: 1},
            {team: 'Dale Gas', name: 'Sevin', points: 0, gamesPlayed: 1},
            {team: 'Dale Gas', name: 'Erik', points: 0, gamesPlayed: 1},
            {team: 'Dale Gas', name: 'Alfred', points: 0, gamesPlayed: 1},
            {team: 'Dale Gas', name: 'Niko', points: 0, gamesPlayed: 1},
            {team: 'Dale Gas', name: 'Brandon', points: 0, gamesPlayed: 1},
            {team: 'Dale Gas', name: 'Greg', points: 0, gamesPlayed: 1},
            ...
            {team: 'Uptempo', name: 'Mike Lopez', points: 0, gamesPlayed: 1},
            ...
            {team: 'Young Bucs', name: 'Reynaldo', points: 0, gamesPlayed: 1},
            ...
            {team: 'Elements', name: 'Jason Ward', points: 0, gamesPlayed: 1},
            {team: 'Elements', name: 'Tu Pham', points: 0, gamesPlayed: 1},
            ...
            {team: 'DEATH ROW', name: 'DJ Vernon', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Tre', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Rick', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Nick', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Rafa', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Gary', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Speedy', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Criss Acevedo', points: 0, gamesPlayed: 1},
            ...
            {team: '1UP', name: 'Robert Yang', points: 0, gamesPlayed: 1},
            {team: '1UP', name: 'Ajay Mattu', points: 0, gamesPlayed: 1},
            {team: '1UP', name: 'Van Vong', points: 0, gamesPlayed: 1},
            {team: '1UP', name: 'Bernard Le', points: 0, gamesPlayed: 1},
            {team: '1UP', name: 'Quang Nguyen', points: 0, gamesPlayed: 1},
            {team: '1UP', name: 'Victor Xayavong', points: 0, gamesPlayed: 1},
            {team: '1UP', name: 'Zay Watson', points: 0, gamesPlayed: 1},
            {team: '1UP', name: 'Steven Goytia', points: 0, gamesPlayed: 1},
            {team: '1UP', name: 'Bo', points: 0, gamesPlayed: 1},
            {team: 'DragonBallerZ', name: 'Michael', points: 0, gamesPlayed: 1},
            {team: 'DragonBallerZ', name: 'Juan', points: 0, gamesPlayed: 1},
            {team: 'DragonBallerZ', name: 'David', points: 0, gamesPlayed: 1},
            {team: 'DragonBallerZ', name: 'Axel', points: 0, gamesPlayed: 1},
            {team: 'DragonBallerZ', name: 'Earl', points: 0, gamesPlayed: 1},
            {team: 'DragonBallerZ', name: 'Shaun', points: 0, gamesPlayed: 1},
            {team: 'DragonBallerZ', name: 'Christian', points: 0, gamesPlayed: 1},
            {team: 'DragonBallerZ', name: 'Q', points: 0, gamesPlayed: 1},
