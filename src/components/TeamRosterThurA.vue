      ...
      onMounted(async () => {
        ...
        if (!snapshot.exists()) {
          ...
          const initialRoster = [
            ...
            {team: 'DEATH ROW', name: 'Derek Vernon', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Tre Jefferson', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Victor Ramirez', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Steven Royal', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Markieth Taylor', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Nate Jordan', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Anthony Howard', points: 0, gamesPlayed: 1},
            {team: 'DEATH ROW', name: 'Cristian Acevedo', points: 0, gamesPlayed: 1},
