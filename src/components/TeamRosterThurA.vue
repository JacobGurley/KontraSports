    ...
    setup(){
      ...
      onMounted(async () => {
        ...
        if (!snapshot.exists()) {
          ...
          const initialRoster = [
            {team: 'AIM BLOCC', name: 'Player 1', points: 0, gamesPlayed: 1},
            {team: 'AIM BLOCC', name: 'Player 2', points: 0, gamesPlayed: 1},
            {team: 'AIM BLOCC', name: 'Player 3', points: 0, gamesPlayed: 1},
            {team: 'AIM BLOCC', name: 'Player 4', points: 0, gamesPlayed: 1},
            {team: 'AIM BLOCC', name: 'Player 5', points: 0, gamesPlayed: 1},
            {team: 'AIM BLOCC', name: 'Player 6', points: 0, gamesPlayed: 1},
            {team: 'AIM BLOCC', name: 'Player 7', points: 0, gamesPlayed: 1},
            {team: 'AIM BLOCC', name: 'Player 8', points: 0, gamesPlayed: 1},
            {team: 'AIM BLOCC', name: 'Player 9', points: 0, gamesPlayed: 1},
            {team: 'AIM BLOCC', name: 'Player 10', points: 0, gamesPlayed: 1},
