<template>
  <div class="rules-container">
    ...
    <div class="rules-update-box">
      <h3>Recent Rule Updates</h3>
      <ul>
        <li>
          <span class="rule-badge updated">UPDATED</span>
          Team roster size is no longer limited to 10 players.
        </li>
        <li>
          <span class="rule-badge updated">UPDATED</span>
          Teams are now allowed 3 timeouts per game. Unused timeouts may carry over to subsequent periods of the same game.
        </li>
        <li>
          <span class="rule-badge new">NEW</span>
          Rosters will be finalized by the start of Week 3. After Week 3, roster additions must be approved by the League Commissioner.
        </li>
        <li>
          <span class="rule-badge new">NEW</span>
          A maximum of 10 championship shirts will be provided free of charge to each championship team.
        </li>
      </ul>
    </div>
    ...
    <ul>
      ...
      <li>3) Game fees ($50) must be paid in full before the game starts.</li>
    ...
    <ol>
      ...
      <li class="rule-changed">
        <span class="rule-badge updated">UPDATED</span>
        8) Teams are allowed 3 timeouts per game. Unused timeouts may carry over to subsequent periods of the same game.
      </li>
    ...
    <ol>
      ...
      <li class="rule-changed">
        <span class="rule-badge updated">UPDATED</span>
        3) There is no maximum roster size for a team.
      </li>
      <li class="rule-new">
        <span class="rule-badge new">NEW</span>
        4) Rosters will be finalized by the start of Week 3. After Week 3, roster additions will only be permitted in cases of injury, player departure, or other approved circumstances. Any roster changes must be reviewed and approved by the League Commissioner on a team-by-team basis.
      </li>
      <li class="rule-new">
        <span class="rule-badge new">NEW</span>
        5) A maximum of 10 championship shirts will be provided free of charge to each championship team. Any additional shirts for rostered players, coaches, or supporters must be purchased through the league.
      </li>
      <li>
        6) Uniform/Jewelry/Eye-wear: Every player must use Basketball Attire at all time while playing. The commissioner will have final authority on what is and what is not basketball attire. Absolutely no jewelry is allowed during games. Sports Goggles is the only piece of eye wear allowed.
      </li>
      <li>
        7) Forfeit / Points: It will be an automatic loss for teams who forfeit a game. Winning team will receive a win and +25 on point differential. Losing team will receive -25 on point differential. Must give 24 hour notice to avoid paying forfeit fee ($90). If failed to do so, team must pay the forfeit fee or they will not qualify for postseason play if we cannot find a replacement team to play in their place.
      </li>
      <li>
        8) Conduct: Team Players, Coaches, and fans must always conduct themselves in a respectful manner. Bad/Hostile Conduct is not allowed in KONTRA. Teams, Coaches, and Fans who cannot conduct themselves in a respectful manner will be immediately escorted out of the gym, with their team subject to forfeiting the game.
      </li>
      <li>
        9) Refunds: Full Refunds will only be made prior to the season starting. Partial Refunds will be given if reason is valid or deemed necessary/urgent. A Refund of 30 dollars will be given for each game. No Refunds allowed after 3 games played in that season.
      </li>
      <li>
        10) HOME AND VISITOR: The HOME team shall wear white or light colored uniforms and the VISITING team shall wear dark uniforms.
      </li>
      <li>
        11) Refs have full jurisdiction on if a game needs to be called if in the event there is conflict that can not be resolved in a short period of time. If a league commissioner is not present at the time, Refs will follow our guidelines and make their decision if the game should proceed or not. Refunds will not be given out if the game ends early. The game will be cancelled and the league will review based on what transpired to give both teams a loss or determine who will receive a win.
      </li>
    </ol>
  </div>
</template>
