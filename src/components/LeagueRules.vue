<template>
    <Nav />
    <div class="width">
      <h2 class="h2">KONTRA IMPORTANT RULES</h2>
      <ul>
    <li class="bold">All players must have filled out a waiver either online or in person or they will not be allowed to play.</li>
    ...
    <p class="space">Additional Notes:</p>
    <ol>
    ...
    <p class="spaceb">Overtime is RUNNING CLOCK and one timeout per Overtime.</p>
    ...
    <h2 class="h2">Kontra Basketball League Rules</h2>
    <ol>
      ...
      <li class="bold">5) Backcourt violations occur after 10 seconds.</li>
      ...
      <li class="bold">10) Any physical conduct (non basketball play) or verbal abuse; ZERO tolerance on refs, game officials, Kontra employees and players will result in two game suspension minimum, with potential to be suspended for an entire season depending on the situation.</li>
    ...
    <h2 class="h2">IMPORTANT ADDITIONAL RULES:</h2>
    <ol>
      <li>
      ...
      <li>
        5) Forfeit / Points: It will be dash an automatic loss for teams who forfeit a game. Winning team will receive a win and +25 on point differential. Losing team will receive -25 on point differential.
      </li>
      <li>
