      ...
      setup(){
        ...
        onMounted(async () => {
          ...
          if (!snapshot.exists()) {
            ...
            const initialRoster = [
              {team: 'DEATH ROW', name: 'Player 1', points: 0, gamesPlayed: 1},
              {team: 'DEATH ROW', name: 'Player 2', points: 0, gamesPlayed: 1},
              {team: 'DEATH ROW', name: 'Player 3', points: 0, gamesPlayed: 1},
              {team: 'DEATH ROW', name: 'Player 4', points: 0, gamesPlayed: 1},
              {team: 'DEATH ROW', name: 'Player 5', points: 0, gamesPlayed: 1},
              {team: 'DEATH ROW', name: 'Player 6', points: 0, gamesPlayed: 1},
              {team: 'DEATH ROW', name: 'Player 7', points: 0, gamesPlayed: 1},
              {team: 'DEATH ROW', name: 'Player 8', points: 0, gamesPlayed: 1},
              {team: 'DEATH ROW', name: 'Player 9', points: 0, gamesPlayed: 1},
              {team: 'DEATH ROW', name: 'Player 10', points: 0, gamesPlayed: 1},
