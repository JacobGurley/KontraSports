<template>
  ...
  setup() {
    ...
    const games = ref([
       ...
       { date: '10-08', time: '6:50 PM', courtNumber: "", homeTeam: '60pointgame', awayTeam: 'Juss Hoop', score: "" },
       { date: '10-08', time: '7:40 PM', courtNumber: "", homeTeam: 'True Grit', awayTeam: 'Adobros', score: "" },
