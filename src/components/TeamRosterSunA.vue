    ...
    onMounted(async () => {
      ...
      if (!snapshot.exists()) {
        ...
        const initialRoster = [
          ...
          {team: 'Practice Squad', name: 'Reggie', points: 0, gamesPlayed: 1},
          ...
          {team: 'Practice Squad', name: 'Austin', points: 0, gamesPlayed: 1},
          {team: 'Practice Squad', name: 'Matterson', points: 0, gamesPlayed: 1},
          {team: 'Practice Squad', name: 'Eric', points: 0, gamesPlayed: 1},
