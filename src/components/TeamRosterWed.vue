      ...
      onMounted(async () => {
        ...
        if (!snapshot.exists()) {
          ...
          const initialRoster = [
            ...
            {team: 'Tita Slaya', name: 'Michael', points: 0, gamesPlayed: 1},
            {team: 'Tita Slaya', name: 'Paolo', points: 0, gamesPlayed: 1},
            {team: 'Tita Slaya', name: 'Najie', points: 0, gamesPlayed: 1},
            {team: 'Tita Slaya', name: 'Ken', points: 0, gamesPlayed: 1},
            {team: 'Tita Slaya', name: 'Dale', points: 0, gamesPlayed: 1},
            {team: 'Tita Slaya', name: 'Ray', points: 0, gamesPlayed: 1},
            {team: 'Tita Slaya', name: 'Vince', points: 0, gamesPlayed: 1},
            {team: 'Tita Slaya', name: 'Martin', points: 0, gamesPlayed: 1},
            {team: 'Tita Slaya', name: 'JC', points: 0, gamesPlayed: 1},
            ...
            {team: 'TUBT', name: 'Carlos M', points: 0, gamesPlayed: 1},
            {team: 'TUBT', name: 'Eric E', points: 0, gamesPlayed: 1},
            {team: 'TUBT', name: 'Guillermo M', points: 0, gamesPlayed: 1},
            {team: 'TUBT', name: 'Curtis W', points: 0, gamesPlayed: 1},
            {team: 'TUBT', name: 'Jon L', points: 0, gamesPlayed: 1},
