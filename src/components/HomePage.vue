<template>
  <div class="container">
    ...
    <div class="links">
      <p class="reg">
        <a href="https://docs.google.com/forms/d/e/1FAIpQLSdUlHfOk92NlLWwgmSKHkZ5UGCgnVzsxTYfIXMLoRk6QI1cig/viewform" target="_blank" rel="noopener noreferrer">Click Here for 2025 Fall Registration </a>
      </p>
      <p class="waiver">
